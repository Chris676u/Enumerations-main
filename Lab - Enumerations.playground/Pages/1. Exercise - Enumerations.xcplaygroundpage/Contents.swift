 ...
 */
enum Suit{ case clubs, spades, diammonds, hearts
...
func getFortune(cardSuit: Suit){
    ...
    case .diammonds:
    print("You will fail in life.")
    case .hearts:
    print("You will be succesfull snsn.")
    }
}
...
print(" the value for \(ace.suit) is \(ace.value)...")
print(" the value for \(king.suit) is \(king.value)...")
print(ace)
print(king)
